...
class PersonaGenerator:
    def __init__(self, llm: ChatVertexAI, k: int = 5):
...
class DocumentationAgent:
    def __init__(self, llm: ChatVertexAI, k: Optional[int] = None):
        # 各種ジェネレータの初期化
...
# 実行方法:
# uv run python -m documentation_agent.main --task "ユーザーリクエストをここに入力してください"
# 実行例）
