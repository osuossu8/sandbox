...
from api.settings import DatabaseSettings
...
def run_migrations_online() -> None:
    ...
    config.set_section_option("alembic", "DB_PORT", database_settings.DB_PORT)
    config.set_section_option("alembic", "DB_NAME", database_settings.DB_NAME)
